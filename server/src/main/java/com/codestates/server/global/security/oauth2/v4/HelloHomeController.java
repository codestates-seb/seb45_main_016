package com.codestates.server.global.security.oauth2.v4;
...
public class HelloHomeController {
    ...
    @GetMapping("/oauth2")
    public String home(@RegisteredOAuth2AuthorizedClient("kakao")OAuth2AuthorizedClient authorizedClient) {
